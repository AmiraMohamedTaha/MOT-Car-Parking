...
ExecuteQueryModified('SELECT `currentNearnessLevel`,`SensorId` FROM `GROUP_66843` where id in (select max(id) from `GROUP_66843` group by SensorId)', Grid_1_callbackFunc);
